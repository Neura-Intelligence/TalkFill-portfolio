...
const HeroSection = () => {
  ...
  return (
    <div className="relative isolate overflow-hidden bg-gray-900 h-screen">
      ...
      />
      <div className="absolute bg-cyan-900 -z-10 top-0 left-0 w-full h-screen opacity-100 bg-opacity-70" />
        ...
        <div className="h-screen flex flex-col mx-auto max-w-2xl align-content-center justify-center">
          <div className="text-center">
            ...
            <div className="mt-10 flex items-center justify-center gap-x-6">
              <a
                href="#"
                className="rounded-md bg-cyan-500 px-3.5 py-1.5 text-base font-semibold leading-7 text-white shadow-sm hover:bg-cyan-600 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-cyan-400 "
              >
                Get started
              </a>
              <a
